...
const saveAnswerAndNext = () => {
  ...
  // Create updated answers object including the current selected answer
  ...
  if (nextIndex < questions.length) {
    // Move to next question and set selected option if previously answered
    setCurrentIndex(nextIndex);
    setSelectedOption(updatedAnswers[nextIndex] || null);
  } else {
    // Last question answered, submit exam with updated answers
